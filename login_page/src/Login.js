...
import './Login.css';
 class Login extends React.Component{
    constructor(props) {
	  ...
	  myCancelHandler = (event) => {
        const usercancel = this.state.username;
        const passcancel = this.state.password;
		console.log(usercancel);
		console.log(passcancel);
		usercancel = '';
		passcancel = '';
		//this.setState({ username: '',password: ''});
		//this.
                ...
                <div>
                  <div className="login_box">
                  	...
                  	<div className="part_field">
                        ...
                        <form onSubmit={this.mySubmitHandler} ref="form">
                          <input
                            type='text'
						  ...
						  <button onCancel={this.myCancelHandler}>Cancel</button>
						  </div>
                        </form>
		                  </content_login>
	                  </div>
